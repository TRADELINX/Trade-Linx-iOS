//
//  MaskedProgressLabelView.swift
//  MartinsApp
//
//  Created by Neil Jain on 10/31/19.
//  Copyright © 2019 Ratnesh Jain. All rights reserved.
//

import UIKit

class MaskedProgressLabelView: UIView {
    ...
    var font: UIFont = UIFont.systemFont(ofSize: UIFont.labelFontSize) {
        didSet {
    ...
    var progressTintColor: UIColor = UIColor.tintBlue {
        didSet {
